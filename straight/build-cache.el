...
#s(hash-table test equal data ("straight" ("2026-05-12 22:30:51" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2026-05-12 22:30:51" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2026-05-12 22:30:51" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2026-05-12 22:30:51" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2026-05-12 22:30:51" nil (:type git :repo "https://github.com/emacsmirror/nongnu_elpa.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2026-05-12 22:30:51" nil (:type git :host github :repo "dimitri/el-get" :build nil :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2026-05-12 22:30:51" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2026-05-12 22:39:30" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2026-05-12 22:39:30" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "no-littering" ("2026-05-12 22:39:37" ("emacs" "compat") (:type git :host github :repo "emacscollective/no-littering" :package "no-littering" :local-repo "no-littering")) "compat" ("2026-05-12 22:39:37" ("emacs") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "evil" ("2026-05-12 22:39:59" ("emacs" "cl-lib" "goto-chg" "nadvice") (:type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2026-05-12 22:39:57" ("emacs") (:type git :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "evil-collection" ("2026-05-12 22:40:12" ("emacs" "evil" "annalist") (:type git :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection" :package "evil-collection" :local-repo "evil-collection")) "annalist" ("2026-05-12 22:40:08" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/annalist.el" :package "annalist" :local-repo "annalist.el")) "which-key" ("2026-05-12 22:40:16" ("emacs") (:type git :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "general" ("2026-05-12 22:40:25" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/general.el" :package "general" :local-repo "general.el")) "catppuccin-theme" ("2026-05-12 22:40:29" ("emacs") (:type git :host github :repo "catppuccin/emacs" :package "catppuccin-theme" :local-repo "emacs")) "all-the-icons" ("2026-05-12 22:40:47" ("emacs") (:type git :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "doom-modeline" ("2026-05-12 22:41:08" ("emacs" "compat" "nerd-icons" "shrink-path") (:type git :host github :repo "seagle0128/doom-modeline" :package "doom-modeline" :local-repo "doom-modeline")) "nerd-icons" ("2026-05-12 22:40:56" ("emacs") (:type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el" :package "nerd-icons" :local-repo "nerd-icons.el")) "shrink-path" ("2026-05-12 22:41:08" ("emacs" "s" "dash" "f") (:type git :host gitlab :repo "bennya/shrink-path.el" :package "shrink-path" :local-repo "shrink-path.el")) "s" ("2026-05-12 22:41:01" nil (:type git :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "dash" ("2026-05-12 22:41:05" ("emacs") (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "f" ("2026-05-12 22:41:08" ("emacs" "s" "dash") (:type git :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "command-log-mode" ("2026-05-12 22:41:11" nil (:type git :host github :repo "lewang/command-log-mode" :package "command-log-mode" :local-repo "command-log-mode")) "ivy" ("2026-05-12 22:41:17" ("emacs") (:type git :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :host github :repo "abo-abo/swiper" :package "ivy" :local-repo "swiper")) "ivy-rich" ("2026-05-12 22:41:19" ("emacs" "ivy") (:type git :host github :repo "Yevgnen/ivy-rich" :package "ivy-rich" :local-repo "ivy-rich")) "counsel" ("2026-05-12 22:41:20" ("emacs" "ivy" "swiper") (:files ("counsel.el" "counsel-pkg.el") :package "counsel" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "swiper" ("2026-05-12 22:41:20" ("emacs" "ivy") (:files ("swiper.el" "swiper-pkg.el") :package "swiper" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "ivy-prescient" ("2026-05-12 22:41:23" ("emacs" "prescient" "ivy") (:type git :files ("ivy-prescient.el" "ivy-prescient-pkg.el") :host github :repo "radian-software/prescient.el" :package "ivy-prescient" :local-repo "prescient.el")) "prescient" ("2026-05-12 22:41:23" ("emacs") (:files ("prescient.el" "prescient-pkg.el") :package "prescient" :local-repo "prescient.el" :type git :repo "radian-software/prescient.el" :host github)) "helpful" ("2026-05-12 22:41:31" ("emacs" "dash" "s" "f" "elisp-refs") (:type git :host github :repo "Wilfred/helpful" :package "helpful" :local-repo "helpful")) "elisp-refs" ("2026-05-12 22:41:30" ("dash" "s") (:type git :files (:defaults (:exclude "elisp-refs-bench.el") "elisp-refs-pkg.el") :host github :repo "Wilfred/elisp-refs" :package "elisp-refs" :local-repo "elisp-refs")) "hydra" ("2026-05-12 22:41:36" ("cl-lib" "lv") (:type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2026-05-12 22:41:35" nil (:files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "org" ("2026-05-12 22:42:53" ("emacs") (:type git :host github :protocol https :repo "emacs-straight/org-mode" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "lsp-mode" (nil ("emacs" "dash" "f" "ht" "spinner" "markdown-mode" "lv" "eldoc")) "company" ("2026-05-13 00:24:10" ("emacs" "posframe") (:type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode")) "posframe" ("2026-05-13 00:24:10" ("emacs") (:type git :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "company-box" ("2026-05-13 00:24:12" ("emacs" "dash" "company" "frame-local") (:type git :files (:defaults "images" "company-box-pkg.el") :host github :repo "sebastiencs/company-box" :package "company-box" :local-repo "company-box")) "frame-local" ("2026-05-13 00:24:10" ("emacs") (:type git :host github :repo "sebastiencs/frame-local" :package "frame-local" :local-repo "frame-local")) "projectile" ("2026-05-13 00:24:12" ("emacs" "compat") (:type git :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "counsel-projectile" ("2026-05-13 00:24:13" ("counsel" "projectile") (:type git :host github :repo "ericdanan/counsel-projectile" :package "counsel-projectile" :local-repo "counsel-projectile")) "magit" ("2026-05-13 00:24:13" nil (:type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "forge" ("2026-05-13 00:27:25" ("emacs" "compat" "closql" "cond-let" "emacsql" "ghub" "llama" "magit" "markdown-mode" "seq" "transient" "yaml") (:type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "forge-pkg.el") :host github :repo "magit/forge" :package "forge" :local-repo "forge")) "closql" ("2026-05-13 00:26:40" ("emacs" "compat" "cond-let" "emacsql") (:type git :host github :repo "magit/closql" :package "closql" :local-repo "closql")) "cond-let" ("2026-05-13 00:25:33" ("emacs") (:type git :host github :repo "tarsius/cond-let" :package "cond-let" :local-repo "cond-let")) "emacsql" ("2026-05-13 00:26:40" ("emacs") (:type git :files (:defaults "README.md" "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql" :package "emacsql" :local-repo "emacsql")) "ghub" ("2026-05-13 00:26:56" ("emacs" "compat" "cond-let" "llama" "treepy") (:type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "ghub-pkg.el") :host github :repo "magit/ghub" :package "ghub" :local-repo "ghub")) "llama" ("2026-05-13 00:26:52" ("emacs" "compat") (:type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama" :package "llama" :local-repo "llama")) "treepy" ("2026-05-13 00:26:56" ("emacs") (:type git :host github :repo "volrath/treepy.el" :package "treepy" :local-repo "treepy.el")) "markdown-mode" ("2026-05-13 00:26:57" ("emacs") (:type git :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "seq" ("2026-05-13 00:27:00" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "transient" ("2026-05-13 00:27:22" ("emacs" "compat" "cond-let" "seq") (:type git :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "yaml" ("2026-05-13 00:27:25" ("emacs") (:type git :host github :repo "zkry/yaml.el" :package "yaml" :local-repo "yaml.el")) "evil-nerd-commenter" ("2026-05-13 00:27:41" ("emacs") (:type git :host github :repo "redguardtoo/evil-nerd-commenter" :package "evil-nerd-commenter" :local-repo "evil-nerd-commenter")) "rainbow-delimiters" ("2026-05-13 00:27:43" nil (:type git :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "eterm-256color" ("2026-05-13 00:27:57" ("emacs" "xterm-color" "f") (:type git :files (:defaults "eterm-256color.ti" "eterm-256color-pkg.el") :host github :repo "dieggsy/eterm-256color" :package "eterm-256color" :local-repo "eterm-256color")) "xterm-color" ("2026-05-13 00:27:56" ("emacs") (:type git :host github :repo "atomontage/xterm-color" :package "xterm-color" :local-repo "xterm-color")) "vterm" ("2026-05-13 00:28:08" ("emacs") (:type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm" :package "vterm" :local-repo "emacs-libvterm")) "eshell-git-prompt" ("2026-05-13 00:28:10" ("emacs" "cl-lib" "dash") (:type git :host github :repo "xuchunyang/eshell-git-prompt" :package "eshell-git-prompt" :local-repo "eshell-git-prompt")) "dashboard" ("2026-05-13 00:35:44" ("emacs") (:type git :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/dashboard" :package "dashboard" :local-repo "dashboard")) "all-the-icons-dired" ("2026-05-13 00:46:17" ("emacs" "all-the-icons") (:type git :host github :repo "wyuenho/all-the-icons-dired" :package "all-the-icons-dired" :local-repo "all-the-icons-dired")) "dired-open" ("2026-05-13 00:46:22" ("dash" "dired-hacks-utils" "emacs") (:type git :files ("dired-open.el" "dired-open-pkg.el") :host github :repo "Fuco1/dired-hacks" :package "dired-open" :local-repo "dired-hacks")) "dired-hacks-utils" ("2026-05-13 00:46:22" ("dash" "emacs") (:files ("dired-hacks-utils.el" "dired-hacks-utils-pkg.el") :package "dired-hacks-utils" :local-repo "dired-hacks" :type git :repo "Fuco1/dired-hacks" :host github)) "dired-hide-dotfiles" ("2026-05-13 00:46:25" ("emacs") (:type git :host github :repo "mattiasb/dired-hide-dotfiles" :package "dired-hide-dotfiles" :local-repo "dired-hide-dotfiles")) "org-bullets" ("2026-05-13 01:08:33" nil (:type git :host github :repo "integral-dw/org-bullets" :package "org-bullets" :local-repo "org-bullets")) "visual-fill-column" ("2026-05-13 01:11:22" ("emacs") (:type git :host codeberg :repo "joostkremers/visual-fill-column" :package "visual-fill-column" :local-repo "visual-fill-column"))))
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package-pkg use-package-ensure use-package-diminish use-package-delight use-package-core use-package-ensure-system-package use-package-bind-key use-package use-package-autoloads use-package-lint use-package-jump) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
you must turn of these features completely.") (register-definition-prefixes "no-littering" '("emacs-session-filename" "no-littering-")) (provide 'no-littering-autoloads)) "goto-chg" ((goto-chg goto-chg-autoloads) (autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn &optional MODES)" t) (register-definition-prefixes "evil-collection" '("evil-collection-")) (provide 'evil-collection-autoloads)) "which-key" ((which-key which-key-autoloads) (defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
(fn &optional SHORT-NAMES _)") (register-definition-prefixes "general" '("general-")) (provide 'general-autoloads)) "catppuccin-theme" ((catppuccin-theme-autoloads catppuccin-definitions catppuccin-theme) (when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (register-definition-prefixes "catppuccin-theme" '("catppuccin-" "define-catppuccin-flavor")) (provide 'catppuccin-theme-autoloads)) "all-the-icons" ((all-the-icons-faces all-the-icons-autoloads all-the-icons) (autoload 'all-the-icons-icon-for-dir "all-the-icons" "Get the formatted icon for DIR.
...
(fn &optional ARG FAMILY)" t) (register-definition-prefixes "all-the-icons" '("all-the-icons-")) (provide 'all-the-icons-autoloads)) "nerd-icons" ((nerd-icons nerd-icons-autoloads nerd-icons-data nerd-icons-faces) (autoload 'nerd-icons-install-fonts "nerd-icons" "Helper function to download and install the latests fonts based on OS.
...
(fn &rest ARG-OVERRIDES)") (register-definition-prefixes "nerd-icons" '("nerd-icons-")) (provide 'nerd-icons-autoloads)) "s" ((s s-autoloads) (register-definition-prefixes "s" '("s-")) (provide 's-autoloads)) "dash" ((dash-autoloads dash) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn &optional ARG)" t) (register-definition-prefixes "command-log-mode" '("clm/" "command-log-mode-" "global-command-log-mode")) (provide 'command-log-mode-autoloads)) "ivy" ((ivy-overlay ivy-autoloads colir ivy ivy-faces) (register-definition-prefixes "colir" '("colir-")) (autoload 'ivy-resume "ivy" "Resume the last completion session, or SESSION if non-nil.
...
(fn &optional ARG)" t) (register-definition-prefixes "ivy-rich" '("ivy-rich-")) (provide 'ivy-rich-autoloads)) "swiper" ((swiper-autoloads swiper) (autoload 'swiper-avy "swiper" "Jump to one of the current swiper candidates with `avy'." t) (autoload 'swiper-backward "swiper" "`isearch-backward' with an overview.
...
to the current value of `default-directory'." t) (autoload 'counsel-file-register "counsel" "Search file in register.
...
(fn &optional ARG)" t) (register-definition-prefixes "counsel" '("counsel-" "ivy-function-called-at-point")) (provide 'counsel-autoloads)) "prescient" ((prescient-autoloads prescient) (autoload 'prescient-filter "prescient" "Use QUERY to filter list of CANDIDATES.
...
(fn FILTER-TYPE KBD-STRING)" nil t) (register-definition-prefixes "prescient" '("prescient-" "selectrum-")) (provide 'prescient-autoloads)) "ivy-prescient" ((ivy-prescient ivy-prescient-autoloads) (defvar ivy-prescient-mode nil "Non-nil if Ivy-Prescient mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "ivy-prescient" '("ivy-prescient-")) (provide 'ivy-prescient-autoloads)) "elisp-refs" ((elisp-refs-autoloads elisp-refs) (autoload 'elisp-refs-function "elisp-refs" "Display all the references to function SYMBOL, in all loaded
elisp files.
...
(fn NAME BODY &optional DOCSTRING &rest HEADS)" nil t) (function-put 'defhydra 'lisp-indent-function 'defun) (function-put 'defhydra 'doc-string-elt 3) (register-definition-prefixes "hydra" '("defhydra" "hydra-")) (register-definition-prefixes "hydra-examples" '("hydra-" "org-agenda-cts" "whitespace-mode")) (register-definition-prefixes "hydra-ox" '("hydra-ox")) (provide 'hydra-autoloads)) "org" ((ob-csharp ob-gnuplot org-id ob-haskell ob-exp org-element ob-julia org-colview org-protocol ob-java ob-sass ob-lisp org-faces ob-ditaa org-inlinetask org-pcomplete ob-ruby ob-lua ox-man ol-gnus ol-docview org-ctags ob-python ob-eshell ob-core org-src org-list ox-icalendar ob-ref ox-beamer org-archive ob-matlab ob ol-irc org-refile org-tempo org-capture org-attach ob-comint ob-org org-cycle org-fold org-crypt ob-sqlite org-element-ast ob-C ob-R org-macs ob-screen oc-natbib org-num ox-md org-feed ob-shell ob-perl org-lint org-macro oc-biblatex ox-latex ob-groovy org-keys ob-emacs-lisp org-mouse ol-bbdb org-mobile org-indent org-entities ol-eshell org-persist org-footnote ob-table ob-dot org-plot org-loaddefs ob-clojure ox-ascii ox ol-eww ob-processing ob-makefile org-datetree ob-forth org-clock oc org-goto ol-bibtex oc-bibtex ol org ox-odt org-fold-core org-duration ol-rmail ob-plantuml ob-maxima ob-latex ox-org ob-sql org-attach-git oc-basic ol-doi ob-js ol-info ob-css ob-awk org-timer ob-scheme ol-mhe ox-html ob-lob ox-publish ol-w3m ob-eval ob-lilypond ob-ocaml ob-octave org-table ob-tangle ox-texinfo ob-sed ob-calc ol-man oc-csl ox-koma-letter org-agenda ob-fortran org-habit org-version org-compat)) "posframe" ((posframe-benchmark posframe-autoloads posframe) (autoload 'posframe-workable-p "posframe" "Test posframe workable status.") (autoload 'posframe-show "posframe" "Pop up a posframe to show STRING at POSITION.
...
(fn &optional ARG)" t) (register-definition-prefixes "company-box" '("company-box-")) (register-definition-prefixes "company-box-doc" '("company-box-")) (register-definition-prefixes "company-box-icons" '("company-box-icons-")) (provide 'company-box-autoloads)) "projectile" ((projectile-autoloads projectile) (autoload 'projectile-version "projectile" "Get the Projectile version as string.
...
(fn &optional ARG)" t) (define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0") (register-definition-prefixes "projectile" '("compilation-find-file-projectile-find-compilation-buffer" "def-projectile-commander-method" "delete-file-projectile-remove-from-cache" "projectile-" "savehist-additional-variables")) (provide 'projectile-autoloads)) "counsel-projectile" ((counsel-projectile-autoloads counsel-projectile) (autoload 'counsel-projectile-find-file "counsel-projectile" "Jump to a file in the current project.
...
(fn &optional ARG)" t) (register-definition-prefixes "counsel-projectile" '("counsel-projectile-")) (provide 'counsel-projectile-autoloads)) "magit" (nil) "cond-let" ((cond-let-autoloads cond-let) (register-definition-prefixes "cond-let" '("cond-let")) (provide 'cond-let-autoloads)) "emacsql" ((emacsql-mysql emacsql-pg emacsql-psql emacsql-sqlite-builtin emacsql-compiler emacsql-sqlite emacsql-sqlite-module emacsql-autoloads emacsql) (autoload 'emacsql-show-last-sql "emacsql" "Display the compiled SQL of the s-expression SQL expression before point.
A prefix argument causes the SQL to be printed into the current buffer.

(fn &optional PREFIX)" t) (register-definition-prefixes "emacsql" '("emacsql-")) (register-definition-prefixes "emacsql-compiler" '("emacsql-")) (register-definition-prefixes "emacsql-mysql" '("emacsql-mysql-")) (register-definition-prefixes "emacsql-pg" '("emacsql-pg-connection")) (register-definition-prefixes "emacsql-psql" '("emacsql-psql-")) (register-definition-prefixes "emacsql-sqlite" '("emacsql-")) (register-definition-prefixes "emacsql-sqlite-builtin" '("emacsql-sqlite-builtin-connection")) (register-definition-prefixes "emacsql-sqlite-module" '("emacsql-sqlite-module-connection")) (provide 'emacsql-autoloads)) "closql" ((closql closql-autoloads) (register-definition-prefixes "closql" '("closql-" "eieio-")) (provide 'closql-autoloads)) "llama" ((llama llama-autoloads \.dir-locals) (autoload 'llama "llama" "Expand to a `lambda' expression that wraps around FN and BODY.
...
(fn &optional ARG)" t) (register-definition-prefixes "llama" '("##" "all-completions" "elisp-" "intern" "lisp--el-match-keyword@llama" "llama-")) (provide 'llama-autoloads)) "treepy" ((treepy-autoloads treepy) (register-definition-prefixes "treepy" '("treepy-")) (provide 'treepy-autoloads)) "ghub" ((ghub-graphql gsexp ghub-autoloads \.dir-locals ghub ghub-legacy) (autoload 'ghub-clear-caches "ghub" "Clear all caches that might negatively affect Ghub.
...
(fn &optional ARG)" t) (register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown")) (provide 'markdown-mode-autoloads)) "seq" ((seq-24 seq-autoloads seq seq-25 seq-pkg) (register-definition-prefixes "seq-24" '("seq")) (autoload 'seq-subseq "seq-25" "Return the sequence of elements of SEQUENCE from START to END.
END is exclusive.
...
(fn SEQUENCE)") (register-definition-prefixes "seq-25" '("seq-")) (provide 'seq-autoloads)) "transient" ((transient-autoloads transient) (autoload 'transient-insert-suffix "transient" "Insert a SUFFIX into PREFIX before LOC.
...
(fn PREFIX LOC)") (function-put 'transient-remove-suffix 'lisp-indent-function 'defun) (register-definition-prefixes "transient" '("find-function-advised-original" "transient")) (provide 'transient-autoloads)) "yaml" ((yaml yaml-autoloads) (register-definition-prefixes "yaml" '("yaml-")) (provide 'yaml-autoloads)) "forge" ((forge-semi forge forge-db forge-post forge-revnote forge-gitea forge-client forge-notify forge-autoloads forge-pullreq forge-repo forge-gitlab forge-tablist forge-issue forge-topic forge-discussion forge-gogs forge-core forge-repos forge-github \.dir-locals forge-commands forge-bitbucket forge-forgejo forge-topics) (defvar forge-add-default-bindings t "Whether to add Forge's bindings to various Magit keymaps.
...
comparisons/benchmarks with libraries that offer similar functionality." t) (register-definition-prefixes "xterm-color" '("+xterm-color--table-256+" "xterm-color-")) (provide 'xterm-color-autoloads)) "eterm-256color" ((eterm-256color eterm-256color-autoloads) (autoload 'eterm-256color-mode "eterm-256color" "Minor mode that adds 256color support to term/ansi-term.
...
(fn &optional ARG)" t) (register-definition-prefixes "eterm-256color" '("eterm-256color-")) (provide 'eterm-256color-autoloads)) "vterm" ((vterm-autoloads vterm) (autoload 'vterm-module-compile "vterm" "Compile vterm-module." t) (autoload 'vterm--bookmark-handler "vterm" "Handler to restore a vterm bookmark BMK.
...
(fn &optional ARG)" t) (register-definition-prefixes "vterm" '("vterm-")) (provide 'vterm-autoloads)) "eshell-git-prompt" ((eshell-git-prompt-autoloads eshell-git-prompt) (autoload 'eshell-git-prompt-use-theme "eshell-git-prompt" "Pick up a Eshell prompt theme from `eshell-git-prompt-themes' to use.

(fn THEME)" t) (autoload 'eshell/use-theme "eshell-git-prompt" "List all available themes and pick one from Eshell.

(fn &optional THEME)") (register-definition-prefixes "eshell-git-prompt" '("eshell-git-prompt-" "with-face")) (provide 'eshell-git-prompt-autoloads)) "dashboard" ((dashboard-widgets dashboard dashboard-autoloads) (autoload 'dashboard-open "dashboard" "Open (or refresh) the *dashboard* buffer.
...
(fn &optional ARG)" t) (register-definition-prefixes "all-the-icons-dired" '("all-the-icons-dired-")) (provide 'all-the-icons-dired-autoloads)) "dired-hacks-utils" ((dired-hacks-utils dired-hacks-utils-autoloads) (register-definition-prefixes "dired-hacks-utils" '("dired-")) (provide 'dired-hacks-utils-autoloads)) "dired-open" ((dired-open dired-open-autoloads) (autoload 'dired-open-file "dired-open" "Try `dired-open-functions' to open the thing under point.
...
(fn &optional ARG)" t) (register-definition-prefixes "dired-open" '("dired-open-")) (provide 'dired-open-autoloads)) "dired-hide-dotfiles" ((dired-hide-dotfiles-autoloads dired-hide-dotfiles) (autoload 'dired-hide-dotfiles-mode "dired-hide-dotfiles" "Toggle `dired-hide-dotfiles-mode'.
...
(fn &optional ARG)" t) (register-definition-prefixes "dired-hide-dotfiles" '("dired-hide-dotfiles-")) (provide 'dired-hide-dotfiles-autoloads)) "org-bullets" ((org-bullets org-bullets-autoloads) (autoload 'org-bullets-mode "org-bullets" "Use UTF8 bullets in Org mode headings.
...
(fn &optional ARG)" t) (register-definition-prefixes "org-bullets" '("org-bullets-")) (provide 'org-bullets-autoloads)) "visual-fill-column" ((visual-fill-column visual-fill-column-autoloads) (autoload 'visual-fill-column-mode "visual-fill-column" "Soft-wrap lines according to `fill-column'.
...
(fn &optional ARG)" t) (autoload 'visual-fill-column-for-vline "visual-fill-column" "Hook function for `visual-line-mode-hook'.
Use this function to enable and disable `visual-fill-column-mode' in
conjunction with `visual-line-mode'.") (autoload 'visual-line-fill-column-mode "visual-fill-column" "Enable `visual-line-mode' and soft-wrap lines according to `fill-column'.
...
#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version (16 "https://github.com/emacs-straight/org-mode.git") "use-package" nil "bind-key" nil "no-littering" nil "compat" nil "evil" nil "cl-lib" nil "goto-chg" nil "evil-collection" nil "annalist" nil "which-key" nil "general" nil "catppuccin-theme" nil "all-the-icons" nil "doom-modeline" nil "nerd-icons" nil "shrink-path" nil "s" nil "dash" nil "f" nil "command-log-mode" nil "ivy" nil "ivy-rich" nil "counsel" nil "swiper" nil "ivy-prescient" nil "prescient" nil "helpful" nil "elisp-refs" nil "hydra" nil "lv" nil "org" (org :type git :host github :protocol https :repo "emacs-straight/org-mode" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))) "lsp-mode" nil "ht" nil "company" nil "posframe" nil "company-box" nil "frame-local" nil "projectile" nil "counsel-projectile" nil "magit" nil "forge" nil "closql" nil "cond-let" nil "emacsql" nil "ghub" nil "llama" nil "treepy" nil "markdown-mode" nil "seq" nil "transient" nil "yaml" nil "evil-nerd-commenter" nil "rainbow-delimiters" nil "term" nil "eterm-256color" nil "xterm-color" nil "vterm" nil "eshell-git-prompt" nil "eshell" nil "dired" nil "dashboard" nil "all-the-icons-dired" nil "dired-open" nil "dired-hacks-utils" nil "dired-hide-dotfiles" nil "org-bullets" nil "visual-fill-column" nil)) melpa #s(hash-table test equal data (version 3 "use-package" nil "bind-key" nil "no-littering" (no-littering :type git :host github :repo "emacscollective/no-littering") "compat" nil "evil" (evil :type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil") "cl-lib" nil "goto-chg" (goto-chg :type git :host github :repo "emacs-evil/goto-chg") "evil-collection" (evil-collection :type git :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection") "annalist" (annalist :type git :host github :repo "noctuid/annalist.el") "which-key" (which-key :type git :host github :repo "justbur/emacs-which-key") "general" (general :type git :host github :repo "noctuid/general.el") "catppuccin-theme" (catppuccin-theme :type git :host github :repo "catppuccin/emacs") "all-the-icons" (all-the-icons :type git :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el") "doom-modeline" (doom-modeline :type git :host github :repo "seagle0128/doom-modeline") "nerd-icons" (nerd-icons :type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el") "shrink-path" (shrink-path :type git :host gitlab :repo "bennya/shrink-path.el") "s" (s :type git :host github :repo "magnars/s.el") "dash" (dash :type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "f" (f :type git :host github :repo "rejeep/f.el") "command-log-mode" (command-log-mode :type git :host github :repo "lewang/command-log-mode") "ivy" (ivy :type git :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :host github :repo "abo-abo/swiper") "ivy-rich" (ivy-rich :type git :host github :repo "Yevgnen/ivy-rich") "counsel" (counsel :type git :files ("counsel.el" "counsel-pkg.el") :host github :repo "abo-abo/swiper") "swiper" (swiper :type git :files ("swiper.el" "swiper-pkg.el") :host github :repo "abo-abo/swiper") "ivy-prescient" (ivy-prescient :type git :files ("ivy-prescient.el" "ivy-prescient-pkg.el") :host github :repo "radian-software/prescient.el") "prescient" (prescient :type git :files ("prescient.el" "prescient-pkg.el") :host github :repo "radian-software/prescient.el") "helpful" (helpful :type git :host github :repo "Wilfred/helpful") "elisp-refs" (elisp-refs :type git :files (:defaults (:exclude "elisp-refs-bench.el") "elisp-refs-pkg.el") :host github :repo "Wilfred/elisp-refs") "hydra" (hydra :type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "lsp-mode" (lsp-mode :type git :files (:defaults "clients/*.*" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode") "ht" (ht :type git :host github :repo "Wilfred/ht.el") "company" (company :type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode") "posframe" (posframe :type git :host github :repo "tumashu/posframe") "company-box" (company-box :type git :files (:defaults "images" "company-box-pkg.el") :host github :repo "sebastiencs/company-box") "frame-local" (frame-local :type git :host github :repo "sebastiencs/frame-local") "projectile" (projectile :type git :host github :repo "bbatsov/projectile") "counsel-projectile" (counsel-projectile :type git :host github :repo "ericdanan/counsel-projectile") "magit" (magit :type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "forge" (forge :type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "forge-pkg.el") :host github :repo "magit/forge") "closql" (closql :type git :host github :repo "magit/closql") "cond-let" (cond-let :type git :host github :repo "tarsius/cond-let") "emacsql" (emacsql :type git :files (:defaults "README.md" "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql") "ghub" (ghub :type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "ghub-pkg.el") :host github :repo "magit/ghub") "llama" (llama :type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama") "treepy" (treepy :type git :host github :repo "volrath/treepy.el") "markdown-mode" (markdown-mode :type git :host github :repo "jrblevin/markdown-mode") "seq" nil "transient" (transient :type git :host github :repo "magit/transient") "yaml" (yaml :type git :host github :repo "zkry/yaml.el") "evil-nerd-commenter" (evil-nerd-commenter :type git :host github :repo "redguardtoo/evil-nerd-commenter") "rainbow-delimiters" (rainbow-delimiters :type git :host github :repo "Fanael/rainbow-delimiters") "term" nil "eterm-256color" (eterm-256color :type git :files (:defaults "eterm-256color.ti" "eterm-256color-pkg.el") :host github :repo "dieggsy/eterm-256color") "xterm-color" (xterm-color :type git :host github :repo "atomontage/xterm-color") "vterm" (vterm :type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm") "eshell-git-prompt" (eshell-git-prompt :type git :host github :repo "xuchunyang/eshell-git-prompt") "eshell" nil "dired" nil "dashboard" (dashboard :type git :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/dashboard") "all-the-icons-dired" (all-the-icons-dired :type git :host github :repo "wyuenho/all-the-icons-dired") "dired-open" (dired-open :type git :files ("dired-open.el" "dired-open-pkg.el") :host github :repo "Fuco1/dired-hacks") "dired-hacks-utils" (dired-hacks-utils :type git :files ("dired-hacks-utils.el" "dired-hacks-utils-pkg.el") :host github :repo "Fuco1/dired-hacks") "dired-hide-dotfiles" (dired-hide-dotfiles :type git :host github :repo "mattiasb/dired-hide-dotfiles") "org-bullets" (org-bullets :type git :host github :repo "integral-dw/org-bullets") "visual-fill-column" (visual-fill-column :type git :host codeberg :repo "joostkremers/visual-fill-column"))) gnu-elpa-mirror #s(hash-table test equal data (version 3 "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "cl-lib" nil "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "term" nil "eshell" nil "dired" nil)) nongnu-elpa #s(hash-table test equal data (version (5 "https://github.com/emacsmirror/nongnu_elpa.git") "cl-lib" nil "term" nil "eshell" nil "dired" nil)) el-get #s(hash-table test equal data (version 2 "cl-lib" nil "term" nil "eshell" nil "dired" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "cl-lib" nil "term" nil "eshell" nil "dired" nil))))

("dired-hide-dotfiles" "dired-hacks-utils" "dired-open" "all-the-icons-dired" "dashboard" "eshell" "eshell-git-prompt" "vterm" "xterm-color" "eterm-256color" "term" "rainbow-delimiters" "evil-nerd-commenter" "yaml" "transient" "seq" "markdown-mode" "treepy" "llama" "ghub" "emacsql" "cond-let" "closql" "forge" "magit" "counsel-projectile" "projectile" "frame-local" "company-box" "posframe" "company" "org" "org-bullets" "lv" "hydra" "elisp-refs" "helpful" "prescient" "ivy-prescient" "swiper" "counsel" "ivy-rich" "ivy" "command-log-mode" "f" "dash" "s" "shrink-path" "nerd-icons" "doom-modeline" "all-the-icons" "catppuccin-theme" "general" "which-key" "annalist" "evil-collection" "nadvice" "goto-chg" "cl-lib" "evil" "compat" "no-littering" "visual-fill-column" "bind-key" "use-package" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa" "emacs" "straight")
